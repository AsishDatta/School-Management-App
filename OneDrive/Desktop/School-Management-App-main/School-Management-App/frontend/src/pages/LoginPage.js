        ...
        <ThemeProvider theme={defaultTheme}>
            <Grid container component="main" sx={{ height: '100vh' }}>
                ...
                <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                    ...
                    >
                        <Typography variant="h4" sx={{ mb: 3, color: "#2c2143", fontWeight: 600 }}>
                            {role} Login
                        </Typography>
                        <Typography variant="body1" sx={{ mb: 4, color: "#7f56da", textAlign: 'center' }}>
                        ...
                        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ width: '100%' }}>
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    borderColor: "#7f56da", 
                                    mb: 2, 
                                    '&:hover': { borderColor: "#7f56da", backgroundColor: "#f3e5f6" }
                                }}
                            >
                                Login as Guest
                            </Button>
